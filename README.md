该文件用来测试和展示书写README的各种markdown语法。GitHub的markdown语法在标准的markdown语法基础上做了扩充，称之为`GitHub Flavored Markdown`。简称`GFM`，GFM在GitHub上有广泛应用，除了README文件外，issues和wiki均支持markdown语法。(我就是看这篇文章入门的，感觉很不错，于是把精华部分整理一下，做一个备份，方便以后自己查看，同时也可以和大家分享)
...
##<a name="link"/>链接
###链接外部URL
[我的博客](http://maozhenggang.github.io/share-list-pages/ "悬停显示")   语法如下：
```
[我的博客](http://maozhenggang.github.io/share-list-pages/"悬停显示")
```
###链接的另一种写法
[我的博客][id]  

[id]:http://maozhenggang.github.io/share-list-pages/"悬停显示"   
语法如下：
```
[我的博客][id]
[id]:http://maozhenggang.github.io/share-list-pages/"悬停显示"
